...
- **[Connect Wallet Button](/docs/components/connect-wallet-button)** - Abstract Global Wallet connection with dropdown menu
- **[Abstract Avatar](/docs/components/abstract-avatar)** - User profile avatars from Abstract Portal with tier styling
- **[SIWE Auth](/docs/components/siwe-auth)** - Sign-in with Ethereum authentication using Iron Session
