...
const mockUsers: FarcasterUser[] = [
  ...
  },
  {
    ...
    display_name: "Nik 🎩",
    pfp_url:
      "https://wrpcd.net/cdn-cgi/image/anim=false,fit=contain,f=auto,w=336/https%3A%2F%2Fipfs.decentralized-content.com%2Fipfs%2Fbafkreidaldog5lil6ljnrm7kawyusapkcgx63fsseslgnyw4b2gdemoxzy",
  ...
  },
  {
    ...
    pfp_url:
      "https://wrpcd.net/cdn-cgi/imagedelivery/BXluQx4ige9GuW0Ia56BHw/b663cd63-fecf-4d0f-7f87-0e0b6fd42800/anim=false,fit=contain,f=auto,w=336",
  ...
  },
  {
    ...
    pfp_url:
      "https://imagedelivery.net/BXluQx4ige9GuW0Ia56BHw/415baeae-ab4c-4d2f-bccd-3f319e89ec00/original",
...
const simulateSearch = async (
  ...
  const allMatches = mockUsers.filter(
    (user) =>
  ...
  return (
    <>
      <div className="space-y-4">
        ...
        {!apiKey && (
          <div className="mb-2 bg-blue-50/50 dark:bg-blue-950/50 border border-blue-400 dark:border-blue-600 rounded-md p-3">
            <div className="flex items-center gap-2 text-sm text-blue-700 dark:text-blue-300">
              <FlaskConical className="h-4 w-4" />
              <span className="font-medium">Simulation Mode</span>
            </div>
            <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
              Using mock data for testing. Try searching: &quot;vitalik&quot;,
              &quot;dwr&quot;, &quot;hellno&quot;, &quot;nik&quot;, etc.
            </p>
          </div>
        )}
